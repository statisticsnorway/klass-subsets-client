module.exports = {
    ...
    //subSetsServiceEndpointAUTH: 'https://subsets-client.staging-bip-app.ssb.no/auth/be/subsets-service/auth/v1/subsets/',
    subSetsServiceEndpoint: 'http://localhost:5000/api/v1/subsets/',
    subSetsServiceEndpointAUTH: 'http://localhost:5000/api/v1/subsets/',
