...
export default function ChangelogPage() {
   ...
   return (
       <div className='page'>
           ...
           <Paragraph>Adjusted to the new response structure from the subset service.</Paragraph>           <Title size={4}>v0.4.5 og v0.4.6</Title>
           ...
           <Paragraph>Pointer style for the form navigation.</Paragraph>
           <Paragraph>Disabled editing for published subsets (inputs, adding code lists, adding codes, reordering, drag and drop).</Paragraph>
           ...
           <Paragraph>Disabled "valid until" and "version valid from" input fields.</Paragraph>
