    ...
    return (
        <>
            <div style={{display: 'relative', width: '600px', padding: '5px', position: 'relative'}}>
                ...
                <h6 className='tooltip' style={{display: 'inline', position: 'absolute', ariaLabel: 'notifications-label-rank', right: '45px', marginBlockEnd: '0'}}>{t('Rank')}
                <span className="tooltiptext rank-tooltip" role="tooltip" id='notifications-label-rank'>{t('Code rank tooltip')}</span>
                </h6>
            </div>
